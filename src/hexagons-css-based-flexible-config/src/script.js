...
Note: A rounding issue might appear in preview. Before implementation, it should be evaluated if that's the only place where this happens. This implementation worked in production during its creation. As browsers and engines change over time, this can't be guaranteed in the future.
